"use strict";/*!
               ...
               *
               */
!function(){function e(){var e=[{idOfImportLink:"component-header",destination:"#container",operation:"prepend"},{idOfImportLink:"component-codingWindow",destination:"#content"},{idOfImportLink:"component-about",destination:"#content"},{idOfImportLink:"component-footer",destination:"#content"}];e.forEach(t)}function t(e){var t=document.getElementById(e.idOfImportLink)["import"],r=t.body.childNodes||[],o=document.querySelector(e.destination);r.forEach(function(t){n(t,o,e.operation)})}function n(e,t,n){"prepend"===n?t.insertBefore(e,t.childNodes[0]):t.appendChild(e)}var r=Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/));"serviceWorker"in navigator&&("https:"===window.location.protocol||r)&&navigator.serviceWorker.register("service-worker.js").then(function(e){e.onupdatefound=function(){if(navigator.serviceWorker.controller){var t=e.installing;t.onstatechange=function(){switch(t.state){case"installed":break;case"redundant":throw new Error("The installing service worker became redundant.")}}}}})["catch"](function(e){console.error("Error during service worker registration:",e)}),e()}(),function(){function e(){a(),t()}function t(){var e=document.querySelector("#runCode");e.addEventListener("click",function(){o(),i(),r()})}function n(e){return s.find(function(t){return t.id===e}).codeMirrorInstance}function r(){var e=n("javascriptCodeMirror"),t=document.querySelector("#userAddedJS"),r=document.createElement("script");t&&t.remove(),r.text=e.getValue(),document.body.appendChild(r)}function o(){var e=n("cssCodeMirror"),t=document.querySelector("#userAddedCSS"),r=document.createElement("style");t&&t.remove(),r.appendChild(document.createTextNode(e.getValue())),document.body.appendChild(r)}function i(){var e=n("htmlCodeMirror"),t=document.querySelector("#htmlOutput");t.innerHTML=e.getValue()}function a(){var e=document.querySelectorAll("[data-code-mirror-text-area]");s=[].map.call(e,function(e){var t=window.CodeMirror.fromTextArea(e,{lineNumbers:!0});return{codeMirrorInstance:t,id:e.id}})}var s=[];setTimeout(e,800)}();var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};/**
 * @license
